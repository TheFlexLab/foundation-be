...
const EmbedingRoute = require("../routes/EmbedingRoute");
const ArticleRoutes = require("../routes/ArticleRoutes");
const BlockchainRoutes = require("../routes/BlockchainRoutes");
const PushNotifications = require("../service/pushNotifications");
...
module.exports = function (app) {
  ...
  app.use("/", isUnderMaintenance, BlockchainRoutes);
  ...
  app.use("/chatbot", isUnderMaintenance, EmbedingRoute);
  app.use("/article", isUnderMaintenance, ArticleRoutes);
  app.use("/pushNotifications", isUnderMaintenance, PushNotifications);
  app.use("/emails", isUnderMaintenance, Emails);
  app.use("/app", isUnderMaintenance, AppRoutes);
  // app.use(error);
};
